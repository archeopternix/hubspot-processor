...
var ContactDefinition = ObjectDefinition{
	...
	Attributes: []AttributeDefinition{
		...
		{Name: "address", Description: "Publicly verified professional street address; do not use a private residence", Research: true, Export: true},
		{Name: "city", Description: "Publicly verified professional city; do not infer a private residence", Research: true, Export: true},
